package org.demo.prime.faces.bean;
...
public class OrderMB implements Serializable{
	...
	public void save() {
		try { 
			...
			// Use merge instead of persist or you'll have a org.hibernate.PersistentObjectException: detached entity passed to persist: org.demo.common.Item
